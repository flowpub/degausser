...
// FlowContent is a set of node names,
// for the nodes that are in the HTML flow content category.
var FlowContent = []string{
	...
	"video",
	"wbr",
	// special cases, assuming specific conditions are met
	"area",
	// special cases, for logic to work
	"body",
	"dd",
	"dl",
	"dt",
