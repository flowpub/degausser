...
func main() {
	s := `<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head>
  ...
  <body>
    <div class="chapter introduction type-1" id="chapter-i">
      ...
      <div class="ugc chapter-ugc">
        <p class="nonindent">
          ...
          brown belly, slightly domed and <strong>divided</strong> by arches into stiff sections.
        ...
        <p class="indent">
          ...
          out on the table – Samsa was a <em>travelling salesman</em> – and above it
          there hung a <mark>picture that he had recently cut out of an illustrated
          magazine and housed in a nice, gilded frame. It showed a lady fitted
          out with a fur hat and fur boa who sat upright,</mark> raising a heavy fur
        ...
        <p class="indent">
          ...
          because he was used to <span>sleeping on his right, and in his present state
          couldn’t get into that position. However hard he threw himself onto
          his right, he always rolled back to where he was. </span>He must have tried
        ...
        <p class="indent">
          ...
          more like quarter to seven. Had the alarm clock not rung? He could see
          from the bed that it had been set for four o’clock as it should have
          been; it certainly must have rung. Yes, but was it possible to quietly
          sleep through that furniture-rattling noise? True, he had not slept
          ...
          sick? But that would be extremely strained and suspicious as in
        ...
        <p class="indent">
          ...
          resolve themselves today. He did not have the slightest doubt that the
          change in his voice was nothing more than the first sign of a serious
          cold, which was an occupational hazard for travelling salesmen.
        </p>
        <p class="indent">
          ...
          about painfully. “This is something that can’t be done in bed”, Gregor
        ...
        <p class="indent">
          ...
          free of it in whatever way he could at whatever sacrifice. At the same
          time, though, he did not forget to remind himself that calm
          ...
          confidence or cheer to offer him. “Seven o’clock, already”, he said to
          himself when the clock struck again, “seven o’clock, and there’s still
          a fog like this.” And he lay there quietly a while longer, breathing
          lightly as if he perhaps expected the total stillness to bring things
